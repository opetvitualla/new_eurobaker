    ...
    <div class="modal-dialog modal-lg" style="max-width:900px;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Stock Transfer Discrepancy</h5>
            ...
            <div class="modal-body">
                <div class="form-body">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3">
                                <label class="fbold" for="supplier">Stock Transfer No:</label>
                                <div class="div_value so_number">sample text</div>
                            </div>
                            <div class="col-md-3">
                                <label class="fbold" for="supplier">Received By</label>
                                <div class="div_value so_receive_by">John Doe</div>
                            </div>
                            <div class="col-md-12">
                                <hr> </div>
                        </div>
                        <div class="cont-po">
                            ...
                            <div class="notes_disc">
                                <div class="fbold mt-4">Note / Reason:</div>
