$(document).ready(function () {
     ...
     var table_outlets = $('#table_outlets').DataTable({
          ...
          "ajax": {
               "url": base_url + "manageoutlets/get_outlets",
               "type": "POST"
          },
          "columnDefs": [
               {
     ...
     $(document).on('submit', '#Outlet_Add', function (e) {
          ...
          $.ajax({
               url: base_url + 'manageoutlets/add_outlet',
               data: formData,
               processData: false,
               contentType: false,
               cache: false,
     ...
     $(document).on('click', '#view_Outlet_Details', function () {
          ...
          $.ajax({
               url: base_url + 'manageoutlets/view_details',
               type: "post",
               data: { "id": id },
               dataType: 'json',
               success: function (data) {
     ...
     $(document).on('submit', '#Outlet_Edit', function (e) {
          ...
          $.ajax({
               url: base_url + 'manageoutlets/update_details',
               data: formData,
               processData: false,
               contentType: false,
               cache: false,
