$(function() {
    ...
    $(window).ready(a), $(window).on("resize", a), $(".sidebartoggler").on("click", function() {
        ...
        if($("body").hasClass("mini-sidebar")){
            console.log()
            $(".navbar-header").removeClass("mini-nav")
            $(".logo-my-icon").show();
            $(".left-sidebar").removeClass("mini-side")

        }else{
            $(".navbar-header").addClass("mini-nav")
            $(".logo-my-icon").hide();
            $(".left-sidebar").addClass("mini-side")
        }
    ...
    }), $(".scroll-sidebar, .right-side-panel, .message-center, .right-sidebar").perfectScrollbar(), $("body").trigger("resize"), $(".list-task li label").on("click", function() {
