...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 13, 2020 at 09:49 PM
...
(2, 13, 'initial', 0, 0, 3333, 1, '2020-07-13'),
(8, 13, 'purchase', 3, 0, 6, 1, '2020-07-13'),
(9, 13, 'purchase', 2, 61, 4, 1, '2020-07-13'),
(10, 12, 'purchase', 2, 5, 1, 1, '2020-07-13'),
(11, 14, 'initial', 0, 0, 3, 1, '2020-07-13');
...
(19, 12, 1, 5, 6, 1, 'purchase', 0, '2020-07-13', '2020-07-13'),
(21, 13, 1, 55, 65, 1, 'purchase', 0, '0000-00-00', '2020-07-13'),
(22, 14, 1, 3, 3, 1, 'initial', 0, '2020-07-13', '2020-07-13');
...
(3, 2, 13, ' test 3333 ', 5, 4, '', '2020-07-13 09:09:46');
...
(2, 'N/A', 3, 1, 1, 'received', '2020-07-13 07:56:44', 1398, ''),
(3, 'N/A', 20, 1, 1, 'received', '2020-07-13 07:58:05', 330, ''),
(4, 'N/A', 23, 1, 1, 'pending', '2020-07-13 07:58:51', 5615, '');
...
(1, 2, 'tesdt', 1, '2020-07-13 09:09:46');
...
(4, 2, 13, 5, 275, 55, '1', '3', '2020-07-13 07:56:44'),
(5, 2, 12, 1, 1123, 1123, '1', '1', '2020-07-13 07:56:44'),
(6, 3, 13, 6, 330, 55, '1', '3', '2020-07-13 07:58:05'),
(7, 4, 12, 5, 5615, 1123, '1', '1', '2020-07-13 07:58:51');
...
(4, 3, 1, 1, 'test', '2020-07-13 08:16:18'),
(8, 3, 1, 1, 'easd asd asdasd', '2020-07-13 08:30:46'),
(9, 2, 1, 1, 'asd asda sd', '2020-07-13 09:09:46');
...
(1, 1, 3, 1, '12x12  spongecake plain (12x12 spongecake plain  )', 'ea', '287.87', 1, 0, '2020-04-07 17:48:29'),
(2, 1, 3, 1, '12x12 choco spongecake choco (12x12 choco spongecake choco  )', 'ea', '311.85', 2, 0, '2020-04-07 17:48:29'),
(3, 1, 1, 1, 'test', 'ea', '12.21', 3, 0, '2020-04-07 18:08:56'),
(4, 1, 3, 1, 'ksd', 'sa', '1212', 4, 0, '2020-04-07 19:06:38'),
(5, 1, 3, 1, '12x12 choco spongecake choco (12x12 choco spongecake choco  )', 'ea', '311.85', 2, 0, '2020-04-07 19:50:05'),
(6, 1, 7, 1, 'jashdkja', 'ad', '1451', 0, 0, '2020-04-07 19:50:32'),
(7, 1, 3, 1, 'ksd', 'sa', '1212', 4, 0, '2020-04-07 19:52:47'),
(8, 1, 10, 1, 'test123', 'ea', '12', 5, 0, '2020-04-07 19:59:18'),
(9, 1, 10, 1, 'test1', 'ea', '12', 5, 0, '2020-04-07 19:59:55'),
(10, 1, 3, 1, 'test 333', 'Sack', '22', 6, 0, '2020-07-02 13:17:29'),
(11, 1, 6, 1, 'new 111', 'Sack', '111', 7, 0, '2020-07-14 00:34:05'),
(12, 1, 3, 1, 'test', 'kg', '1123', 8, 0, '2020-07-14 01:28:30'),
(13, 1, 3, 1, 'test 3333', 'pc', '55', 9, 0, '2020-07-14 01:33:27'),
(14, 1, 3, 1, 'tesr 666', 'Sack', '565', 10, 4, '2020-07-14 03:22:45');
...
--
ALTER TABLE `eb_inventory_movement`
  MODIFY `pk_inv_move_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `eb_item_inventory`
--
ALTER TABLE `eb_item_inventory`
  MODIFY `PK_inventory_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `eb_po_discrepancy_items`
  MODIFY `po_discrepancy_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `eb_purchase_order`
--
ALTER TABLE `eb_purchase_order`
  MODIFY `PK_purchase_order_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `eb_purchase_order_discrepancy`
--
ALTER TABLE `eb_purchase_order_discrepancy`
  MODIFY `pk_po_discrepancy_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `eb_purchase_order_item`
--
ALTER TABLE `eb_purchase_order_item`
  MODIFY `PK_po_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `eb_purchase_order_received`
--
ALTER TABLE `eb_purchase_order_received`
  MODIFY `PK_po_received_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `eb_raw_materials_list`
  MODIFY `PK_raw_materials_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
