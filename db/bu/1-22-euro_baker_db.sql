...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 13, 2020 at 07:21 PM
...
(18, 11, 1, 111, 33, '0', 0, 1, 'initial', 0, '2020-07-13 00:00:00', '0000-00-00 00:00:00');
...
(1, 'N/A', 2, 1, 1, 'processing', '2020-07-13 05:22:21', 621.72, '');
...
(1, 1, 1, 1, 287.87, 287.87, '1', '6', '2020-07-13 05:22:21'),
(2, 1, 2, 1, 311.85, 311.85, '1', '6', '2020-07-13 05:22:21'),
(3, 1, 10, 1, 22, 22, '1', '2', '2020-07-13 05:22:21');
...
(11, 1, 6, 1, 'new 111', 'Sack', '111', 7, '2020-07-14 00:34:05');
...
--
ALTER TABLE `eb_purchase_order`
  MODIFY `PK_purchase_order_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `eb_purchase_order_discrepancy`
--
ALTER TABLE `eb_purchase_order_discrepancy`
  MODIFY `pk_po_discrepancy_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `eb_purchase_order_item`
--
ALTER TABLE `eb_purchase_order_item`
  MODIFY `PK_po_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `eb_purchase_order_received`
--
ALTER TABLE `eb_purchase_order_received`
  MODIFY `PK_po_received_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `eb_raw_materials_list`
  MODIFY `PK_raw_materials_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
