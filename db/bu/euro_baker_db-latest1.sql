...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 19, 2020 at 07:41 PM
...
INSERT INTO `eb_inventory_movement` (`pk_inv_move_id`, `fk_item_id`, `type_entry`, `trans_id`, `from_value`, `value`, `branch_id`, `date_added`, `cal_type`) VALUES
(12, 1, 'initial', 0, 0, 10, 1, '2020-07-13', 'add'),
(13, 2, 'initial', 0, 0, 10, 1, '2020-07-13', 'add'),
(23, 3, 'initial', 0, 0, 10, 1, '2020-07-14', 'add'),
(29, 2, 'purchase', 13, 10, 3, 1, '2020-07-18', 'add'),
(30, 3, 'purchase', 13, 10, 3, 1, '2020-07-18', 'add'),
(31, 1, 'stockout', 7, 10, 2, 1, '2020-07-18', 'sub'),
(32, 2, 'stockout', 8, 13, 1, 1, '2020-07-18', 'sub'),
(33, 3, 'stockout', 9, 13, 2, 1, '2020-07-18', 'sub'),
(34, 2, 'purchase', 14, 12, 2, 1, '2020-07-18', 'add'),
(35, 1, 'stockout', 10, 8, 2, 1, '2020-07-18', 'sub'),
(36, 1, 'stockout', 10, 6, 2, 1, '2020-07-18', 'sub'),
(37, 1, 'stockout', 10, 4, 2, 1, '2020-07-18', 'sub'),
(38, 3, 'stockout', 11, 11, 3, 1, '2020-07-18', 'sub'),
(39, 2, 'stockout', 11, 14, 1, 1, '2020-07-18', 'sub'),
(40, 2, 'stockout', 12, 13, 1, 1, '2020-07-18', 'sub'),
(41, 4, 'initial', 0, 0, 3, 4, '2020-07-18', 'add'),
(44, 7, 'initial', 0, 0, 11, 4, '2020-07-18', 'add'),
(45, 8, 'initial', 0, 0, 11, 4, '2020-07-18', 'add'),
(46, 4, 'purchase', 17, 3, 3, 4, '2020-07-19', 'add'),
(47, 2, 'purchase', 19, 12, 20, 1, '2020-07-19', 'add'),
(48, 9, 'initial', 0, 0, 10, 1, '2020-07-19', 'add'),
(50, 13, 'initial', 0, 0, 0, 4, '2020-07-19', 'add'),
(51, 9, 'transfer', 36, 10, 5, 1, '2020-07-19', 'sub'),
(52, 13, 'transfer', 36, 0, 5, 4, '2020-07-19', 'add');
...
(23, 1, 1, 0, 2, 1, 'stockout', 0, '2020-07-13', '2020-07-18'),
(24, 2, 1, 0, 32, 1, 'purchase', 0, '2020-07-13', '2020-07-19'),
(25, 3, 1, 0, 8, 1, 'stockout', 0, '2020-07-13', '2020-07-18'),
(26, 4, 4, 3, 6, 1, 'purchase', 0, '2020-07-18', '2020-07-19'),
(29, 7, 4, 11, 11, 1, 'initial', 0, '2020-07-18', '2020-07-18'),
(30, 8, 4, 11, 11, 1, 'initial', 0, '2020-07-18', '2020-07-18'),
(31, 9, 1, 10, 5, 1, 'transfer', 0, '2020-07-19', '2020-07-19'),
(33, 13, 4, 0, 5, 1, 'transfer', 0, '2020-07-19', '2020-07-19');

-- --------------------------------------------------------

--
-- Table structure for table `eb_other_discrepancy_items`
--

CREATE TABLE `eb_other_discrepancy_items` (
  `other_discrepancy_item_id` int(11) NOT NULL,
...
--
-- Dumping data for table `eb_other_discrepancy_items`
--

INSERT INTO `eb_other_discrepancy_items` (`other_discrepancy_item_id`, `fk_po_discrepancy_id`, `fk_material_id`, `material_name`, `qty`, `received_qty`, `unit`, `date_added`) VALUES
(1, 6, 7, ' water ', 11, 8, ' 	pc ', '2020-07-19');
...
INSERT INTO `eb_other_outlet_delivery` (`pk_other_deliver_id`, `fk_po_id`, `fk_receiver_id`, `checked_by`, `fk_outlet_recieved_id`, `fk_outlet_to_id`, `date_received`) VALUES
(4, 17, 1, 'opet', 1, 4, '2020-07-19'),
(10, 18, 1, 'test 3333', 1, 4, '2020-07-19');

-- --------------------------------------------------------

--
-- Table structure for table `eb_other_outlet_discrepancy`
--

CREATE TABLE `eb_other_outlet_discrepancy` (
  `pk_other_discrepancy_id` int(11) NOT NULL,
...
--
-- Dumping data for table `eb_other_outlet_discrepancy`
--

INSERT INTO `eb_other_outlet_discrepancy` (`pk_other_discrepancy_id`, `fk_purchase_id`, `reason`, `status`, `date_added`) VALUES
(6, 18, 'test', 1, '2020-07-19');

-- --------------------------------------------------------

--
-- Table structure for table `eb_other_outlet_items`
--

CREATE TABLE `eb_other_outlet_items` (
  `pk_other_item_id` int(11) NOT NULL,
  `fk_other_deliver_id` int(11) NOT NULL,
  `fk_raw_material_id` int(11) NOT NULL,
  `quantity` int(11) NOT NULL,
...
CREATE TABLE `eb_purchase_order` (
  ...
  `remarks` text NOT NULL,
  `fk_received_outlet_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `eb_purchase_order` (`PK_purchase_order_id`, `purchase_order_no`, `FK_supplier_id`, `FK_user_id`, `FK_branch_id`, `status`, `date_added`, `total_amount`, `remarks`, `fk_received_outlet_id`) VALUES
(13, 'N/A', 2, 1, 1, 'received', '2020-07-18 06:02:13', 288, '', 1),
(14, 'N/A', 4, 1, 1, 'received', '2020-07-18 07:43:56', 90, '', 1),
(17, 'N/A', 4, 10, 4, 'received', '2020-07-19 06:06:40', 198, '', 1),
(18, 'N/A', 1, 10, 4, 'received', '2020-07-19 08:27:45', 121, '', 1),
(19, 'N/A', 3, 1, 1, 'received', '2020-07-19 09:22:39', 660, '', 1),
(20, 'N/A', 4, 10, 4, 'pending', '2020-07-19 02:07:11', 330, '', 0),
(21, 'N/A', 1, 1, 1, 'processing', '2020-07-19 02:07:53', 132, '', 0);
...
(3, 14, 'tesdt asasd', 1, '2020-07-18 07:44:53'),
(4, 19, 'teetadsad asd', 1, '2020-07-19 09:23:20');
...
(19, 13, 2, 3, 90, 30, '1', '1', '2020-07-18 06:02:13', '2022-07-14'),
(20, 13, 3, 3, 198, 66, '1', '2', '2020-07-18 06:02:13', '2022-07-14'),
(21, 14, 2, 3, 90, 30, '1', '1', '2020-07-18 07:43:56', '2022-07-14'),
(22, 15, 7, 1, 11, 11, '1', '3', '2020-07-19 05:59:33', '0000-00-00'),
(23, 15, 4, 1, 66, 66, '1', '2', '2020-07-19 05:59:33', '0000-00-00'),
(24, 16, 4, 1, 66, 66, '1', '2', '2020-07-19 06:01:15', '0000-00-00'),
(25, 17, 4, 3, 198, 66, '1', '2', '2020-07-19 06:06:40', '2022-07-28'),
(26, 18, 7, 11, 121, 11, '1', '3', '2020-07-19 08:27:45', '0000-00-00'),
(27, 19, 2, 22, 660, 30, '1', '1', '2020-07-19 09:22:39', '2022-07-21'),
(28, 20, 4, 5, 330, 66, '1', '2', '2020-07-19 02:07:11', '0000-00-00'),
(29, 21, 1, 4, 132, 33, '1', '2', '2020-07-19 02:07:53', '0000-00-00');
...
(15, 13, 1, 1, 'opet', '2020-07-18 06:03:24'),
(16, 14, 1, 1, 'test', '2020-07-18 07:44:53'),
(18, 17, 1, 1, 'opet', '2020-07-19 07:52:45'),
(24, 18, 1, 1, 'test 3333', '2020-07-19 08:40:23'),
(25, 19, 1, 1, 'asdasdasd', '2020-07-19 09:23:20');
...
(4, 4, 5, 1, 'Sugar', 'Sack', '66', 3, 1, '2020-07-19 04:46:58'),
(7, 4, 8, 1, 'water', 'pc', '11', 7, 1, '2020-07-19 05:24:33'),
(8, 4, 3, 1, 'Milk', 'kg', '30', 2, 1, '2020-07-19 05:25:14'),
(9, 1, 9, 1, 'Flour', 'Sack', '100', 9, 5, '2020-07-19 21:20:31'),
(13, 4, 9, 1, 'Flour', 'Sack', '100', 9, 5, '2020-07-19 00:00:00');
...
(7, 2, '30', '30', 1, '2020-07-19 00:02:13'),
(8, 3, '66', '66', 1, '2020-07-19 00:02:13'),
(9, 2, '30', '30', 1, '2020-07-19 01:43:56'),
(10, 7, '11', '11', 4, '2020-07-19 11:59:34'),
(11, 4, '66', '66', 4, '2020-07-19 11:59:34'),
(12, 4, '66', '66', 4, '2020-07-19 12:01:15'),
(13, 4, '66', '66', 4, '2020-07-19 12:06:40'),
(14, 7, '11', '11', 4, '2020-07-19 14:27:45'),
(15, 2, '30', '30', 1, '2020-07-19 15:22:39'),
(16, 3, '66', '33', 1, '2020-07-19 18:39:35'),
(17, 4, '66', '66', 4, '2020-07-19 20:07:11'),
(18, 1, '33', '33', 1, '2020-07-19 20:07:53');
...
INSERT INTO `eb_so_discrepancy_items` (`so_discrepancy_item_id`, `fk_so_discrepancy_id`, `fk_material_id`, `material_name`, `qty`, `received_qty`, `unit`, `date_added`) VALUES
...
(6, 6, 1, ' Coffee ', 3, 2, '', '2020-07-18 04:24:59'),
(7, 9, 3, ' Sugar ', 3, 2, 'Sack', '2020-07-18 07:23:01'),
(10, 10, 1, ' Coffee ', 3, 2, 'Sack', '2020-07-18 08:25:14');
...
INSERT INTO `eb_stock_out` (`PK_stock_out_id`, `FK_user_id`, `fk_requested_id`, `FK_outlet_id`, `FK_segment_id`, `total_items`, `total_amount`, `status`, `date_added`) VALUES
(7, 1, 8, 1, 2, 1, 66, 'approved', '2020-07-18 06:12:11'),
(8, 1, 8, 1, 2, 1, 30, 'approved', '2020-07-18 07:21:52'),
(9, 1, 8, 1, 2, 1, 198, 'approved', '2020-07-18 07:22:50'),
(10, 1, 8, 1, 2, 1, 33, 'approved', '2020-07-18 07:31:36'),
(11, 1, 8, 1, 2, 2, 0, 'approved', '2020-07-18 08:56:48'),
(12, 8, 8, 1, 2, 1, 30, 'approved', '2020-07-18 09:49:49');
...
INSERT INTO `eb_stock_out_approved` (`pk_stockout_approved_id`, `fk_stockout_id`, `fk_approve_user_id`, `counter_checked`, `status`, `date_approved`) VALUES
(7, 7, 1, 'opet 2', 1, '2020-07-18 07:20:01'),
(8, 8, 1, 'opet 3', 1, '2020-07-18 07:21:59'),
(9, 9, 1, 'test 3', 1, '2020-07-18 07:23:01'),
(13, 10, 1, 'testttt', 1, '2020-07-18 08:25:13'),
(14, 11, 1, 'opets', 1, '2020-07-18 09:17:32'),
(15, 12, 1, 'testtt', 1, '2020-07-18 09:50:19');
...
(2, 9, 'kuwang', 1, '2020-07-18 07:23:01'),
(6, 10, 'testtttt', 1, '2020-07-18 08:25:13');
...
(8, 7, 1, 2, 33, '2', '2020-07-18 06:12:11'),
(9, 8, 2, 1, 30, '1', '2020-07-18 07:21:52'),
(10, 9, 3, 3, 66, '2', '2020-07-18 07:22:50'),
(11, 10, 1, 3, 33, '2', '2020-07-18 07:31:36'),
(19, 11, 3, 3, 66, 'kg', '2020-07-18 09:17:18'),
(20, 11, 2, 1, 30, 'kg', '2020-07-18 09:17:18'),
(22, 12, 2, 1, 30, '1', '2020-07-18 09:50:05');
...
INSERT INTO `eb_stock_transfer` (`PK_stock_transfer_id`, `FK_user_id`, `FK_origin_branch_id`, `FK_destination_branch_id`, `stock_out`, `status`, `str_no`, `total_amount`, `date_added`) VALUES
(35, 1, 1, 4, 2, 0, '12', 63, '2020-07-19 18:39:35'),
(36, 1, 1, 4, 1, 1, '1234', 600, '2020-07-19 21:21:48');

-- --------------------------------------------------------

--
-- Table structure for table `eb_stock_transfer_discrepancy`
--

CREATE TABLE `eb_stock_transfer_discrepancy` (
  `pk_st_discrepancy_id` int(11) NOT NULL,
...
--
-- Dumping data for table `eb_stock_transfer_discrepancy`
--

INSERT INTO `eb_stock_transfer_discrepancy` (`pk_st_discrepancy_id`, `fk_transfer_id`, `reason`, `status`, `date_added`) VALUES
(1, 36, 'asdasd', 1, '2020-07-19');
...
INSERT INTO `eb_stock_transfer_items` (`PK_transfer_item_id`, `FK_stock_transfer_id`, `FK_raw_material_id`, `quantity`, `status`, `total`, `item_unit`, `date_added`) VALUES
(24, 35, 2, 2, 0, 30, 'kg', '2020-07-19 18:39:35'),
(25, 35, 3, 1, 0, 33, 'Sack', '2020-07-19 18:39:35'),
(26, 36, 9, 6, 0, 600, 'Sack', '2020-07-19 21:21:48');

-- --------------------------------------------------------

--
-- Table structure for table `eb_stock_transfer_received`
--

CREATE TABLE `eb_stock_transfer_received` (
  `PK_st_received_id` int(11) NOT NULL,
  `FK_transfer_id` int(11) NOT NULL,
  `FK_received_user_id` int(11) NOT NULL,
  `status` int(11) NOT NULL,
  `counter_checked` varchar(100) NOT NULL,
  `date_received` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `eb_stock_transfer_received`
--

INSERT INTO `eb_stock_transfer_received` (`PK_st_received_id`, `FK_transfer_id`, `FK_received_user_id`, `status`, `counter_checked`, `date_received`) VALUES
(1, 36, 10, 1, 'asdasd', '2020-07-19');

-- --------------------------------------------------------

--
-- Table structure for table `eb_st_discrepancy_items`
--

CREATE TABLE `eb_st_discrepancy_items` (
  `st_discrepancy_item_id` int(11) NOT NULL,
  `fk_st_discrepancy_id` int(11) NOT NULL,
  `fk_material_id` int(11) NOT NULL,
  `material_name` varchar(100) NOT NULL,
  `qty` int(11) NOT NULL,
  `received_qty` int(11) NOT NULL,
...
--
-- Dumping data for table `eb_st_discrepancy_items`
--

INSERT INTO `eb_st_discrepancy_items` (`st_discrepancy_item_id`, `fk_st_discrepancy_id`, `fk_material_id`, `material_name`, `qty`, `received_qty`, `units`, `date_added`) VALUES
(1, 1, 9, ' Flour ', 6, 5, ' Sack', '2020-07-19');
...
(8, 'test3', 'password', 3, 1, '1', '2020-04-24 17:58:30'),
(9, 'Frank', 'password', 3, 1, '4', '2020-04-24 18:42:22'),
(10, 'admin2', 'password', 1, 1, '4', '2020-04-24 18:58:45'),
(11, 'test4', 'password', 2, 1, '4', '2020-05-05 18:54:09');
...
(4, 8, 'Cruiser', 'Marion', 'proweaver@example.com2', '21', 'female', '9170 N. Summerhouse St.'),
...
--
-- Indexes for table `eb_other_discrepancy_items`
--
ALTER TABLE `eb_other_discrepancy_items`
  ADD PRIMARY KEY (`other_discrepancy_item_id`);
...
--
-- Indexes for table `eb_other_outlet_discrepancy`
--
ALTER TABLE `eb_other_outlet_discrepancy`
  ADD PRIMARY KEY (`pk_other_discrepancy_id`);

--
-- Indexes for table `eb_other_outlet_items`
--
ALTER TABLE `eb_other_outlet_items`
  ADD PRIMARY KEY (`pk_other_item_id`);
...
--
-- Indexes for table `eb_stock_transfer_discrepancy`
--
ALTER TABLE `eb_stock_transfer_discrepancy`
  ADD PRIMARY KEY (`pk_st_discrepancy_id`);
...
--
-- Indexes for table `eb_stock_transfer_received`
--
ALTER TABLE `eb_stock_transfer_received`
  ADD PRIMARY KEY (`PK_st_received_id`);

--
-- Indexes for table `eb_st_discrepancy_items`
--
ALTER TABLE `eb_st_discrepancy_items`
  ADD PRIMARY KEY (`st_discrepancy_item_id`);
...
--
ALTER TABLE `eb_inventory_movement`
  MODIFY `pk_inv_move_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;

--
-- AUTO_INCREMENT for table `eb_item_inventory`
--
ALTER TABLE `eb_item_inventory`
  MODIFY `PK_inventory_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT for table `eb_other_discrepancy_items`
--
ALTER TABLE `eb_other_discrepancy_items`
  MODIFY `other_discrepancy_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `eb_other_outlet_delivery`
--
ALTER TABLE `eb_other_outlet_delivery`
  MODIFY `pk_other_deliver_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `eb_other_outlet_discrepancy`
--
ALTER TABLE `eb_other_outlet_discrepancy`
  MODIFY `pk_other_discrepancy_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `eb_other_outlet_items`
--
ALTER TABLE `eb_other_outlet_items`
  MODIFY `pk_other_item_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `eb_po_discrepancy_items`
  MODIFY `po_discrepancy_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `eb_purchase_order`
--
ALTER TABLE `eb_purchase_order`
  MODIFY `PK_purchase_order_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `eb_purchase_order_discrepancy`
--
ALTER TABLE `eb_purchase_order_discrepancy`
  MODIFY `pk_po_discrepancy_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `eb_purchase_order_item`
--
ALTER TABLE `eb_purchase_order_item`
  MODIFY `PK_po_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT for table `eb_purchase_order_received`
--
ALTER TABLE `eb_purchase_order_received`
  MODIFY `PK_po_received_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `eb_raw_materials_list`
  MODIFY `PK_raw_materials_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `eb_raw_materials_price_logs`
--
ALTER TABLE `eb_raw_materials_price_logs`
  MODIFY `PK_log_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `eb_so_discrepancy_items`
  MODIFY `so_discrepancy_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `eb_stock_out`
--
ALTER TABLE `eb_stock_out`
  MODIFY `PK_stock_out_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `eb_stock_out_approved`
--
ALTER TABLE `eb_stock_out_approved`
  MODIFY `pk_stockout_approved_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `eb_stock_out_discrepancy`
--
ALTER TABLE `eb_stock_out_discrepancy`
  MODIFY `pk_so_discrepancy_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `eb_stock_out_items`
--
ALTER TABLE `eb_stock_out_items`
  MODIFY `PK_stock_out_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `eb_stock_transfer`
--
ALTER TABLE `eb_stock_transfer`
  MODIFY `PK_stock_transfer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT for table `eb_stock_transfer_discrepancy`
--
ALTER TABLE `eb_stock_transfer_discrepancy`
  MODIFY `pk_st_discrepancy_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `eb_stock_transfer_items`
--
ALTER TABLE `eb_stock_transfer_items`
  MODIFY `PK_transfer_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT for table `eb_stock_transfer_received`
--
ALTER TABLE `eb_stock_transfer_received`
  MODIFY `PK_st_received_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `eb_st_discrepancy_items`
--
ALTER TABLE `eb_st_discrepancy_items`
  MODIFY `st_discrepancy_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
